...
public class SchemaRegistryService {
     ...
     * 
     * @param subject The subject name (typically topic-name-value)
     * @param schema The Avro schema to register
     * @return The schema ID assigned by the registry
     * @throws SchemaRegistryException if registration fails
     */
     ...
     * @param version The schema version (latest if null)
     * @return The Avro schema
     * @throws SchemaRegistryException if retrieval fails
     */
    public Schema getSchema(String subject, Integer version) {
        try {
            String cacheKey = version != null ? subject + "-v" + version : subject + "-latest";
            ...
            Schema schema;
            if (version != null) {
                schema = schemaRegistryClient.getBySubjectAndId(subject, version);
            } else {
            ...
            log.error("Error retrieving schema for subject {} version {}: {}", 
                subject, version, e.getMessage(), e);
            throw new SchemaRegistryException(
