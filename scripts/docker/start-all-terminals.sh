...
open_service_terminal "postgres" "docker/services/postgres.yml" "$TERMINAL_CMD"
...
open_service_terminal "redis" "docker/services/redis.yml" "$TERMINAL_CMD"
...
open_service_terminal "zookeeper" "docker/services/zookeeper.yml" "$TERMINAL_CMD"
...
open_service_terminal "kafka" "docker/services/kafka.yml" "$TERMINAL_CMD"
...
open_service_terminal "prometheus" "docker/services/prometheus.yml" "$TERMINAL_CMD"
...
open_service_terminal "grafana" "docker/services/grafana.yml" "$TERMINAL_CMD"
...
open_service_terminal "trackops-server" "docker/services/trackops-server.yml" "$TERMINAL_CMD"
